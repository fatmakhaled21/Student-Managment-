                            ...
                            <table class="table">
                                ...
                                @foreach($enrollments as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->enroll_no ?? 'No enroll number available' }}</td>
                                        <td>{{ $item->batch ? $item->batch->name : 'No batch assigned' }}</td>
                                        <td>{{ $item->student ? $item->student->name : 'No student assigned' }}</td>
                                        <td>{{ $item->join_date ?? 'No start date available' }}</td>
                                        <td>{{ $item->fee}}</td>
