...
<div class="card">
  ...
  <div class="card-body">
    ...
    <form action="<?php echo e(url('enrollments/' .$enrollments->id)); ?>" method="post">
        ...
        <input type="text" name="batch_id" id="batch_id" value="<?php echo e($enrollments->batch->name ?? ''); ?>" class="form-control">

        <label>Student</label></br>
        <input type="text" name="student_id" id="student_id" value="<?php echo e(optional($enrollments->student)->name); ?>" class="form-control">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Studentmanagement\resources\views/enrollments/edit.blade.php ENDPATH**/ ?>